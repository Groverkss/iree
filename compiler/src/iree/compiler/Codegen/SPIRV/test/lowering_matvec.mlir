// RUN: iree-opt --split-input-file --pass-pipeline='builtin.module(func.func(iree-spirv-select-lowering-strategy-pass, iree-spirv-lower-executable-target-pass))' %s | FileCheck %s

...
#define GEN_PASS_DEF_LLVMGPUVECTORTRANSFERLOWERINGPASS
...
struct LLVMGPUVectorTransferLoweringPass final
    : impl::LLVMGPUVectorTransferLoweringPassBase<
          LLVMGPUVectorTransferLoweringPass> {
